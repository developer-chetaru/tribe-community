...
<head>
    <meta charset="UTF-8">
    <title>Org Staff Reset Password</title>
                ...
                <table width="600" cellspacing="0" cellpadding="0" border="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;">
                    ...
                    <tr>
                        <td style="padding:20px 40px 30px 40px;color:#333;font-size:15px;line-height:1.6;font-family: 'Lexend', Arial, Helvetica, sans-serif;">
                            ...
                            <p style="margin:0 0 15px 0;font-family: 'Lexend', Arial, Helvetica, sans-serif;">You requested a Tribe365® password reset to your account at {{ $organisation ?? '<Organisation>' }}. Click the button below to complete your reset.</p>
                            ...
                            <p style="margin:0 0 15px 0;font-family: 'Lexend', Arial, Helvetica, sans-serif;">If you have any questions, please contact us or {{ $organisation ?? '<Organisation>' }}.</p>
