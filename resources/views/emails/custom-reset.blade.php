...
<head>
    <meta charset="UTF-8">
    <title>Org Tribe365® Password Reset</title>
        ...
        <tr>
            <td align="center">
                <table width="600" cellspacing="0" cellpadding="0" border="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;">
                    <tr>
                        <td style="background:#eb1c24;padding:8px 0;">
                    ...
                    <tr>
                        <td style="padding:20px 40px 30px 40px;color:#333;font-size:15px;line-height:1.6;font-family: 'Lexend', Arial, Helvetica, sans-serif;">
                            ...
                            <p style="margin:0 0 15px 0;font-family: 'Lexend', Arial, Helvetica, sans-serif;">You've been invited by {{ $inviterName ?? '<Name>' }} to join Tribe365® behaviour coach app.</p>
                            <p style="margin:0 0 15px 0;font-family: 'Lexend', Arial, Helvetica, sans-serif;">We support you to maximise your engagement to advance your career, work well with others, and get more out of life.</p>
                            <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin:25px auto;">
                                <tr>
                                    <td bgcolor="#eb1c24" style="border-radius:5px;">
                                        <a href="{{ $url }}" style="display:inline-block;padding:12px 30px;color:#ffffff;text-decoration:none;font-weight:600;background-color:#eb1c24;border-radius:5px;font-family: 'Lexend', Arial, Helvetica, sans-serif;">Set Password</a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center" style="padding:20px;font-size:12px;color:#888;border-top:1px solid #e0e0e0;font-family: \'Lexend\', Arial, Helvetica, sans-serif;padding-top:30px;">
                            © 2026 <span style="color:#eb1c24;font-weight:600;">TRIBE365<sup>®</sup></span> - ALL RIGHTS RESERVED<br>
                            Contact us: <a href="tel:+441325734846" style="color:#888;text-decoration:none;">+44 (0) 1325 734 846</a> | Email: <a href="mailto:team@tribe365.co" style="color:#888;text-decoration:none;">team@tribe365.co</a>
                        </td>
                    </tr>
                </table>
            </td>
