                ...
                <table width="600" cellspacing="0" cellpadding="0" border="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;">
                    ...
                    <tr>
                        <td style="padding:20px 40px 30px 40px;color:#333;font-size:15px;line-height:1.6;font-family: 'Lexend', Arial, Helvetica, sans-serif;">
                            <p style="color:#333;margin:0 0 15px 0;font-size:15px;font-weight:600;font-family: 'Lexend', Arial, Helvetica, sans-serif;">Verify Your Email Address</p>
                            ...
                            <p style="margin:0 0 15px 0;font-family: 'Lexend', Arial, Helvetica, sans-serif;">Or copy and paste this link into your browser:</p>
                            <p style="margin:0 0 15px 0;font-family: 'Lexend', Arial, Helvetica, sans-serif;"><a href="{{ $verificationUrl }}" style="color:#0066cc;text-decoration:underline;word-break:break-all;font-size:12px;">{{ $verificationUrl }}</a></p>
                            <p style="margin:0 0 15px 0;font-family: 'Lexend', Arial, Helvetica, sans-serif;">This verification link will expire in 24 hours.</p>
