      ...
      <table width="520" cellspacing="0" cellpadding="0" border="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
        ...
        <tr>
          <td style="padding:10px 30px 25px 30px;color:#333;font-size:15px;line-height:1.6;">
            ...
            <p style="margin:0 0 15px 0;">Thank you for your payment! Your payment has been successfully processed.</p>
            
            <div style="background:#f5f5f5;border-left:4px solid #EB1C24;padding:15px;margin:20px 0;">
            ...
            <p style="margin:20px 0 15px 0;">Your subscription is now active and you can continue using all features.</p>
            
            <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin:25px auto;">
              <tr>
                <td bgcolor="#EB1C24" style="border-radius:5px;">
                  <a href="{{ route('billing') }}" style="display:inline-block;padding:12px 30px;color:#ffffff;text-decoration:none;font-weight:bold;background-color:#EB1C24;border-radius:5px;">View Billing</a>
                </td>
              </tr>
            </table>
