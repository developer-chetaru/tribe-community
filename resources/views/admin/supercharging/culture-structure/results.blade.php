    ...
    <div class="bg-white p-6 rounded shadow">
        <div class="mb-4 flex gap-4">
            ...
            <a href="{{ route('admin.supercharging.culture-structure.types.index') }}" 
               ...
               <i class="fas fa-book"></i> Types
            </a>
        </div>

        <!-- Filters -->
        <form method="GET" action="{{ route('admin.supercharging.culture-structure.results.index') }}" class="mb-6 bg-gray-50 p-4 rounded">
        ...
        <table class="w-full border-collapse border border-gray-200 text-sm">
            <thead>
                <tr class="bg-gray-100">
                    ...
                    <th class="border border-gray-300 px-4 py-2 text-left font-semibold">Culture Type</th>
                ...
                @forelse($results as $result)
                    <tr class="border border-gray-300 hover:bg-red-50">
                        ...
                        <td class="px-4 py-2 font-semibold">
                            {{ $result->cultureType->title ?? $result->type_key }}
                        </td>
                        <td class="px-4 py-2">
