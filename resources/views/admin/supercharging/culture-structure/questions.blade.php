<x-app-layout>
    ...
    <div class="bg-white p-6 rounded shadow">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('admin.supercharging.culture-structure.questions.create') }}" 
        ...
        <!-- Search and Filter -->
        <form method="GET" action="{{ route('admin.supercharging.culture-structure.questions.index') }}" class="mb-4">
                ...
                @forelse($questions as $question)
                    <tr class="border border-gray-300 hover:bg-red-50">
                        ...
                        <td class="px-4 py-2 flex gap-2 justify-end">
                            <a href="{{ route('admin.supercharging.culture-structure.questions.edit', $question->id) }}"
                               class="rounded p-1 flex items-center justify-center hover:bg-red-50"
                               title="Edit">
                                <img src="{{ asset('images/edit.svg') }}" alt="Edit" class="h-8 w-8">
                            </a>
                            <form action="{{ route('admin.supercharging.culture-structure.questions.destroy', $question->id) }}" 
                                  method="POST" 
