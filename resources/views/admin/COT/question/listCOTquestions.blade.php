<x-app-layout>
    ...
    <div class="bg-white p-6 rounded shadow">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('admin.cot.questions.create') }}" 
        ...
        <!-- Search and Filter -->
        <form method="GET" action="{{ route('admin.cot.questions.index') }}" class="mb-4">
        ...
        <table class="w-full border-collapse border border-gray-200 text-sm">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center py-4 text-gray-500">No questions found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
