<x-app-layout>
    ...
    <div class="bg-white p-6 rounded shadow">
        ...
        <!-- Filters -->
        <form method="GET" action="{{ route('admin.diagnostic.results.index') }}" class="mb-6 bg-gray-50 p-4 rounded">
            ...
            <div class="space-y-6">
                @foreach($results as $resultData)
                    ...
                    <div class="border border-gray-300 rounded-lg p-6">
                        ...
                        <!-- Category Scores -->
                        <div class="space-y-4">
                            <h4 class="font-semibold text-gray-700 mb-3">Results by Category:</h4>
                            @foreach($categoryScores as $categoryTitle => $scoreData)
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <div class="flex justify-between items-center mb-2">
                                        <h5 class="font-medium text-gray-800">{{ $categoryTitle }}</h5>
