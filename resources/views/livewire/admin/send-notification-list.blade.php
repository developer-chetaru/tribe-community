        ...
        <div class="bg-white border border-[#E5E5E5] rounded-lg p-6">
            ...
            <div class="mb-4 flex items-center gap-2">
                ...
                <button
                    ...
                    class="px-4 py-2 bg-[#eb1c24] text-white rounded-md hover:bg-[#000]"
                >
                    Search
                </button>
                <button
                ...
                <table class=" border-collapse w-full">
                    <thead>
                        <tr class="bg-[#F8F9FA] text-left text-gray-600 text-sm">
                            ...
                            <th class="px-4 py-6 w-[23%] min-w-[170px]">Description</th>
                            <th class="px-4 py-6">Links</th>
                            <th class="px-4 py-6 min-w-[170px]">Date Sent</th>
            ...
            <div class="mt-6">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <select wire:model="perPage"
                        class="bg-white border border-gray-300 rounded-lg px-3 py-2 text-[#808080] focus:outline-none min-w-[70px]"
                    >
