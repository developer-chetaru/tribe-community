...
<main class="p-6 flex-1 overflow-y-auto min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow-sm rounded-lg border border-[#E5E5E5] overflow-hidden grid">
        <div class="overflow-x-auto">
            <table class="w-full divide-y divide-gray-200">
                <thead class="bg-[#F8F9FA]">
                    <tr>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">Login Time</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">User</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">Platform</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">Device</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">OS / Browser</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">Location</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">Session Duration</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">Status</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">IP Address</th>
                        <th class="px-6 py-4 text-left text-xs font-medium text-gray-600 uppercase tracking-wider whitespace-nowrap">Actions</th>
                    </tr>
                </thead>
                    ...
                    @forelse($loginSessions as $session)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 ">
                                ...
                                <div class="text-sm text-gray-500 whitespace-nowrap">{{ $session->user->email ?? 'N/A' }}</div>
                            </td>
                            <td class="px-6 py-4 ">
                            ...
                            <td class="px-6 py-4  text-sm text-gray-900 ">
                                @if($session->os_name)
                                    <div class="whitespace-nowrap">{{ $session->os_name }} @if($session->os_version){{ $session->os_version }}@endif</div>
                                @endif
                                @if($session->browser_name)
                                    <div class="text-xs text-gray-500 whitespace-nowrap">{{ $session->browser_name }} @if($session->browser_version){{ $session->browser_version }}@endif</div>
                                @endif
                                @if(!$session->os_name && !$session->browser_name)
                                    <span class="text-gray-400 whitespace-nowrap">N/A</span>
                                @endif
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-900">
                            ...
                            <td class="px-6 py-4 ">
                                <span class="px-2 whitespace-nowrap py-1 text-xs font-semibold rounded-full 
