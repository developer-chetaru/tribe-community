...
<div class="bg-white p-6 rounded shadow" x-data="{ showConfirm: false, valueId: null }">
    <div class="flex justify-between items-center mb-4 pb-2">
        ...
        <div class="flex justify-end mb-3">
            <a wire:navigate href="{{ route('add.directing-value') }}" 
               class="bg-[#EB1C24] text-[16px] text-[#fff] hover:bg-red-600  px-4 py-3 rounded-[8px] flex items-center gap-2 transition">
    ...
    <a href="{{ route('update.directing-value', $val->id) }}"  
        ...
        @empty
            <tr>
                <td colspan="4" class="text-center px-4 py-3">No Directing Values Found</td>
            </tr>
        @endforelse
    </tbody>
</table>
