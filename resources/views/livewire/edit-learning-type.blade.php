 ...
 <h2 class="text-[24px] md:text-[30px] capitalize font-bold text-[#EB1C24]">
  ...
  <div class="max-w-8xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
     <h2  class="text-[24px] font-[500]  mb-5 text-[#EB1C24]">Edit Learning Type</h2>
    ...
    <form wire:submit.prevent="save" class="space-y-4">
        ...
        <div class="flex gap-2">
            <button type="submit" class=" px-6 py-3 text-[#fff] text-[16px] font-[500]  bg-[#EB1C24] rounded-[8px] border border-[#EB1C24]">
                Save
            </button>
            <a href="{{ route('learningtype.list') }}" class="px-6 py-3 text-[#EB1C24] text-[16px] font-[500] border border-[#EB1C24] rounded-[8px] hover:bg-[#EB1C24] hover:text-[#fff]">
                Cancel
            </a>
        </div>
    </form>
