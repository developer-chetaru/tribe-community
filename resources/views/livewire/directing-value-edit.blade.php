...
<div class="flex-1 overflow-auto">
  <div class="max-w-8xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
      <h2  class="text-[24px] font-[500]  mb-4 text-[#EB1C24]">Edit Directing Value</h2>
      ...
      <form wire:submit.prevent="update" class="space-y-4">
          ...
          <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Value URL</label>
              <input type="text" wire:model="value_url"
                     class="w-full border-gray-300 rounded p-2 focus:ring-red-500 focus:border-red-500">
              @error('value_url') <p class="text-red-600 text-sm mt-1">{{ $message }}</p> @enderror
          </div>

          <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Description</label>
              <textarea wire:model="value_desc"
                        class="w-full border-gray-300 rounded p-2 focus:ring-red-500 focus:border-red-500"></textarea>
              @error('value_desc') <p class="text-red-600 text-sm mt-1">{{ $message }}</p> @enderror
          </div>
