...
class HappyIndexController extends Controller
{
     ...
     *     description="Store a new Happy Index (mood status) entry for the authenticated user (Bearer token). userId in body is ignored.",
     *     security={{"bearerAuth":{}}},
     *
     *     @OA\RequestBody(
     *         required=true,
     ...
     *             required={"moodStatus"},
     *
     *             @OA\Property(property="userId", type="integer", deprecated=true, description="Ignored; user is resolved from JWT."),
