...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        // -------------------------
        // Auto-delete subscriptions unpaid for 20 days
        // -------------------------
        $schedule->command('subscriptions:delete-unpaid', ['--days' => 20])
            ->dailyAt('01:00')
            ->timezone('UTC')
            ->withoutOverlapping()
            ->appendOutputTo(storage_path('logs/subscriptions-delete-unpaid.log'));

        // -------------------------
        // Auto-delete basecamp users pending payment for 20 days
        // -------------------------
        $schedule->command('users:delete-pending-payment', ['--days' => 20])
            ->dailyAt('01:15')
            ->timezone('UTC')
            ->withoutOverlapping()
            ->appendOutputTo(storage_path('logs/users-delete-pending-payment.log'));
